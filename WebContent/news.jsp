	...
	<div class="row">
		...
		<div class="col-lg-9 col-md-8 padding-right-30">
			<%
				 ...
				 ArrayList<News> news = pageModel.getList();
			...
			<div class="blog-post">
				...
				<!-- Img -->
				<a href="showctrl?action=tonewsdetails&NId=<%=news.get(i).getNId() %>" class="post-img">
					<img src="<%=news.get(i).getNImage()%>" alt="">
				</a>
				
				<!-- Content -->
				<div class="post-content">
					<h3><a href="showctrl?action=toarticledetails&AId=<%=news.get(i).getNId() %>"><%=news.get(i).getNTitle() %></a></h3>
					...
					<p><%=news.get(i).getNContent() %></p>

					<a href="showctrl?action=tonewsdetails&NId=<%=news.get(i).getNId() %>" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
				</div>
		...
		<div class="sidebar right">
			...
			<div class="widget margin-top-40">
				...
				<div class="info-box margin-bottom-10">
					<p>遇到问题了？告诉我们吧！</p>
					<a href="#" class="button fullwidth margin-top-20"><i class="fa fa-envelope-o"></i>联系我们</a>
				</div>
			</div>
			<!-- Widget / End -->
