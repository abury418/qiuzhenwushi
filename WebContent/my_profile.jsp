...
<div id="dashboard">
	...
	<div class="dashboard-content">
		...
		<div class="row">
		<form action="" method="post" name="myProfile"> 
			<!-- Profile -->
			<div class="col-lg-6 col-md-12">
				<div class="dashboard-list-box margin-top-0">
					...
					<div class="dashboard-list-box-static">
						...
						<!-- Avatar -->
						<div class="edit-profile-photo" style="left-margin:400px">
						...
						<div class="my-profile">
							...
							<label>用户名</label>
							<input value="<%=user.getUserName() %>" type="text" title="username" name="userName">

							<label>手机号</label>
							<input value="<%=user.getUserPhone() %>" type="text" title="userphone" name="userPhone">

							<label>邮箱</label>
							<input value="<%=user.getUserMail() %>" type="text" title="usermail" name="userMail">

							<label>个人介绍</label>
							<textarea id="notes" cols="30" rows="10" title="userbrief" name="userBrief"><%=user.getUserBrief() %></textarea>
						</div>
	
						<button onclick="selectedaction(1);" class="button margin-top-15">保存更改</button>
			...
			<div class="col-lg-6 col-md-12">
				<div class="dashboard-list-box margin-top-0">
					<h4 class="gray">修改密码</h4>
					<div class="dashboard-list-box-static">

						<!-- Change Password -->
						<div class="my-profile">
							<label class="margin-top-0">现密码</label>
							<input type="password" value=<%=user.getUserPassword() %> title="userpwd" name="userPwd">

							<label>新密码</label>
							<input type="password" title="usernewpwd" name="userNewPwd">

							<label>确认密码</label>
							<input type="password" title="useragainpwd" name="userAgainPwd">

							<button onclick="selectedaction(0);" class="button margin-top-15">更改</button>
						</div>
			...
			<script>
				function selectedaction(v){
					if(v==1){
						document.myProfile.action="loginctrl?action=updateuser";
					}
					else{
						document.myProfile.action="loginctrl?action=updateuserpwd";
					}
				}
			</script>
