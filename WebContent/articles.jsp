	...
	<div class="row">
		...
		<div class="col-lg-9 col-md-8 padding-right-30">
			<%
				 ...
				 ArrayList<Article> article = pageModel.getList();
			...
			<div class="blog-post">
				...
				<!-- Img -->
				<a href="showctrl?action=toarticledetails&AId=<%=article.get(i).getAId() %>&AKeyWord=<%=article.get(i).getAKeyWord() %>" class="post-img">
					<img src="<%=article.get(i).getAImage()%>" alt="">
				</a>
				
				<!-- Content -->
				<div class="post-content">
					<h3><a href="showctrl?action=toarticledetails&AId=<%=article.get(i).getAId() %>"><%=article.get(i).getATitle() %></a></h3>

					<ul class="post-meta">
						<li></li>
						<li>关键词：<%=article.get(i).getAKeyWord() %></a></li>
						<li>5 条评论</a></li>
					</ul>

					<p><%=article.get(i).getAContent() %></p>

					<a href="showctrl?action=toarticledetails&AId=<%=article.get(i).getAId() %>" class="read-more">查看全文 <i class="fa fa-angle-right"></i></a>
				</div>
				...
				<ul class="widget-tabs">
					...
					<li>
						<div class="widget-content">
							...
							<div class="widget-text">
								<h5><a href="pages-blog-post.html">标题1 </a></h5>
					...
					<li>
						<div class="widget-content">
							...
							<div class="widget-text">
								<h5><a href="pages-blog-post.html">标题2</a></h5>
					...
					<li>
						<div class="widget-content">
							...
							<div class="widget-text">
								<h5><a href="pages-blog-post.html">标题3</a></h5>
