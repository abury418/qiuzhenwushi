...
<div id="dashboard">
	...
	<div class="dashboard-content">
		...
		<div class="row">
		  <form action="admmanage?action=newarticle" method="post" name="newArticle"> <!--  onSubmit="return checkMineral()" -->
			<div class="col-lg-12">
				<div id="add-listing">
					<!-- Section -->
					<div class="add-listing-section">
						...
						<div class="add-listing-headline">
							<h3><i class="sl sl-icon-doc"></i>文章基本信息</h3>
						</div>

						<!-- Title -->
						<div class="row with-forms">
							<div class="col-md-12">
								<h5>文章标题<i class="tip" data-tip-content="Title of new article"></i></h5>
								<input title="atitle" name="aTitle" class="search-field" type="text" placeholder="文章标题名"/>
							</div>
						</div>
						...
						<div class="row with-forms">
							<!-- Type -->
							<div class="col-md-12">
								<h5>所属专栏<i class="tip" data-tip-content="KeyWord of new article"></i></h5>
								<input title="keyword" name="keyWord" type="text" placeholder="所属专栏名">
							</div>
						</div>
						
						<div class="row with-forms">
							<div class="col-md-12">
								<h5>前文内容<i class="tip" data-tip-content="aContent of new article"></i></h5>
								<input title="acontent" name="aContent" class="search-field" type="text" placeholder="前文内容" style="height:500px"/>
							</div>
						</div>
						<div class="row with-forms">
							<div class="col-md-12">
								<h5>主要内容<i class="tip" data-tip-content="mContent of new article"></i></h5>
								<input title="mcontent" name="mContent" class="search-field" type="text" placeholder="主要内容" style="height:1000px"/>
							</div>
						</div>
						<!-- Row / End -->
					</div>
					...
					<div class="add-listing-section margin-top-45">
						...
						<div class="submit-section">
							<input title="aimg" name="aImg" id="aimgname" type="text" placeholder="图片地址（选择图片上传后自动读取文件名）">
						</div>
						<input type="file" name="file" class="file" style="border:none" id="fileField" onchange="document.getElementById('aimgname').value=this.files[0].name"/> 
